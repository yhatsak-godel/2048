...
export const GameContainer = () => {
  ...
  const { playerName, isPromptOpen, saveName, useDefaultName, requestName } = usePlayerName();
      ...
      <section className="relative z-10 flex w-full flex-col gap-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,320px)]">
          ...
          <div className="flex flex-col gap-4">
            <GameStatus status={gameState.status} playerName={playerName} onEditName={requestName} />
